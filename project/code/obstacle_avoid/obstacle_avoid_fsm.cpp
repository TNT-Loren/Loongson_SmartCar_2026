...
constexpr float k_avoid_decelerate_target_speed = -90.0f;
...
constexpr auto k_avoid_warning_result_timeout = std::chrono::milliseconds(1000);
...
constexpr float k_avoid_turn_target_speed = 10.0f;
...
constexpr float k_avoid_turn_yaw_tolerance = 30.0f;
