...
// ===================================================================
struct VSConfig {
    bool en_terminal_output = (VS_ENABLE_TERMINAL_OUTPUT != 0);
    bool en_guidelines      = (VS_ENABLE_GUIDELINES != 0);
